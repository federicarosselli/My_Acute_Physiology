...
save( OutName, 'Silvia', 'tr', 'Gen', 'Code', 'TOT_trials', 'Shapes_Tot', 'Moving_Shapes_Tot', 'Moving_Shapes_Tot_M', 'G_Tot', 'Dots_Tot', 'Shapes_Succ','Shapes_Fail','Pre_Moving_Shapes_Succ','Moving_Shapes_Succ_M','Pre_Moving_Shapes_Fail','Moving_Shapes_Fail_M','Dots_Succ','Dots_Fail','G_Succ','G_Fail', ...
    'Shapes_Succ_Stim1', 'Shapes_Succ_Stim2','Shapes_Fail_Stim1', 'Shapes_Fail_Stim2', 'Pre_Shapes_Succ_Stim1L', 'Pre_Shapes_Succ_Stim2L', 'Pre_Shapes_Succ_Stim1R', 'Pre_Shapes_Succ_Stim2R', 'Shapes_Succ_Stim1L_M', 'Shapes_Succ_Stim2L_M', 'Shapes_Succ_Stim1R_M', 'Shapes_Succ_Stim2R_M', ...
    'Pre_Shapes_Fail_Stim1L', 'Pre_Shapes_Fail_Stim2L', 'Pre_Shapes_Fail_Stim1R', 'Pre_Shapes_Fail_Stim2R', 'Shapes_Fail_Stim1L_M', 'Shapes_Fail_Stim2L_M', 'Shapes_Fail_Stim1R_M', 'Shapes_Fail_Stim2R_M','Dots_Succ_DotL', 'Dots_Succ_DotR', 'Dots_Fail_DotL', 'Dots_Fail_DotR','Perf_Stim1',...
    'Perf_Stim2', 'Pre_Perf_Stim1_L', 'Pre_Perf_Stim1_R','Pre_Perf_Stim2_L','Pre_Perf_Stim2_R','Perf_Stim1_L_M', 'Perf_Stim1_R_M','Perf_Stim2_L_M','Perf_Stim2_R_M','Perf_DotL','Perf_DotR',...
    'Perf_GL','Perf_GR','Perf_Shapes','Pre_Perf_MovingShapes','Perf_MovingShapes_M','Perf_G','Perf_Dots' );
